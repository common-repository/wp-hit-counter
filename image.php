    ...
    */
          ...
          function display() {
             ...
             // }                       
			  ...
			  if (get_option('wphcu_display_credit') == 1) { 
			  	echo '<br /><small>provided by <a href="http://wordpress.org/extend/plugins/wp-hit-counter">WP Hit Counter</a></small>';
			  } else {
      ...
      class wHitCounter extends WP_Widget {
          ...
          function widget($args, $instance) {
              ...
              echo preg_replace('/(\d)/', "<img src='".WP_PLUGIN_URL."/wp-hit-counter/designs/$style/$1.gif'>", $hits);
              if (get_option('wphcu_display_credit') == 1) { 
			  	echo '<br /><small>Hit Counter provided by <a href="http://wordpress.org/extend/plugins/wp-hit-counter">WP Hit Counter</a></small>';
			  } else {
